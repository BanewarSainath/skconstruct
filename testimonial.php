...
<div class="headbar col-sm-12"><a class="mail" href="mailto:sainathbanewar@gmail.com"> adeshalitkar@gmail.com
  ...
  <div class="profiles container text-center bg-info my-2">
    <h1 class="text-dark"><b></b>Our Testimonials</b></h1><hr>
    <div class="row text-center">
    <div class="col col-md-4  ">
      <img src="img/swapnilsir.jpg" alt="adeshalitkar" class="  rounded img-fluid img-thumbnail ">
      <h4 class="text-light">Swapnil Kshirsagar</h4>
    </div>
    <!--<div class="col mt-md-5">
    <h1 class=" text-center display-4 text-danger">SK Construction</h1>
    </div>-->
    <div class="col col col-md-4 offset-md-4">
      <img src="img/adesh.jpg" alt="adeshalitkar" class="  rounded img-fluid img-thumbnail">
      <h4 class="text-light"> Adesh Sanjay Galitkar</h4>
    </div>
    </div>
